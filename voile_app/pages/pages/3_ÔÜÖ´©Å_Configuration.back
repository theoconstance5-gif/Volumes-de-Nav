...
from style import inject_css, page_header, sidebar_logo

st.set_page_config(page_title="Configuration — La Vague Normande Sport", page_icon="assets/logo_icon.png", layout="wide")
inject_css()
sidebar_logo()
init_db()
